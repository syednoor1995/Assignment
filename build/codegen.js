...
var schemaAstPlugin = __importStar(require("@graphql-codegen/schema-ast"));
...
function performCodegen(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, core_1.codegen)(options)];
                case 1:
                    output = _a.sent();
                    fs.writeFile(path_1.default.join(__dirname, '/graphql/generated/', options.filename), output, function () {
